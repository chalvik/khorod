...
- выполнтие указанные в настоящем документе задания и создайте коммит с изменениями в свой форк проекта;
...
> **Примечание**
> Для генерации миграций и моделей используйте указания, содержащиеся в файле [README.md шаблона пакета](yii2-kg-developer-challenge/README.md).
